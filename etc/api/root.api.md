...
- `GattValueStream :: { readonly limits: { readonly itemCapacity: number; readonly byteCapacity: number; readonly reservedControlCapacity: number; }; readonly overflowPolicy: "latest" | "drop-oldest" | "drop-newest" | "error"; close(): Promise<PortableCleanupRecord>; __@asyncIterator@168(): AsyncIterator<StreamItem<GattValueEvent>, any, any> }`
