...
function fixtureRoot() {
  ...
  writeFile(root, 'package.json', JSON.stringify({ name: 'unified-ble-manager', version: '5.0.0-rc.3' }))
...
describe('build fingerprint (F23)', () => {
  test('generate is deterministic across runs', () => {
    ...
    expect(first.package).toEqual({ name: 'unified-ble-manager', version: '5.0.0-rc.3' })
