  ...
  test('P1-10 local IPC stream overflow stops the remote scan producer', async () => {
    ...
    const bootstrap = {
      ...
      versions: {
        ...
        ipcProtocol: { axis: 'ipc-protocol', selected: { axis: 'ipc-protocol', value: 3 }, localRange: { axis: 'ipc-protocol', minimum: { axis: 'ipc-protocol', value: 3 }, maximum: { axis: 'ipc-protocol', value: 3 } }, remoteRange: { axis: 'ipc-protocol', minimum: { axis: 'ipc-protocol', value: 3 }, maximum: { axis: 'ipc-protocol', value: 3 } } }
      },
      capabilities: {
        schemaVersion: 2,
        backendGeneration,
