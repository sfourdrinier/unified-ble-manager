...
describe('4.0 public package surface', () => {
  test('exposes one production manager authority and isolated authoring/testing seams', () => {
    ...
    const advanced = require('unified-ble-manager/advanced')
    ...
    expect(typeof web.createWebBleManagerWithEnvironment).toBe('function')
    expect(web.createNavigatorWebBleManager).toBeUndefined()
    ...
    expect(typeof advanced.throwIfCleanupFailed).toBe('function')
