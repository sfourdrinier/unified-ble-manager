...
| 10 | `feat/expo-first-class-host` | #44 | fresh exact-SHA adversarial wave complete | 0 | — | `v4.0.0-rc.4` after merge | **ready-for-GitHub-PR; hosted/Apple/review gates pending** |
