...
`unified-ble-manager@4.0.0-rc.3` is the prepared **release-candidate package/API** for the 4.x contract; the RC3 tag workflow publishes this candidate after the exact-main release gates pass. Stable
