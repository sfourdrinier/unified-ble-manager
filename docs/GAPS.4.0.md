...
`unified-ble-manager@4.0.0-rc.3` is the prepared release-candidate package/API. Publication remains pending the RC3 tag workflow; stable `4.0.0` is reserved for the
