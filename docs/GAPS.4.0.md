...
`unified-ble-manager@4.0.0-rc.4.1` is the published, immutable release-candidate package/API. Stable `4.0.0` is reserved for the
post-PR12 release gate. The RC4.1 package does not rewrite the evidence inventory: a backend remains at the support level
