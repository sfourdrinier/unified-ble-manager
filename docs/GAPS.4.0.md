...
`unified-ble-manager@4.0.3` is the published, immutable stable package/API. Immutable `4.0.0`, `4.0.1`, and `4.0.2` remain published history. Backend support labels remain
