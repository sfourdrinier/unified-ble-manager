...
This source targets `5.0.0-rc.8`; verify the published version in the npm registry.
...
After the npm registry lists `5.0.0-rc.8`, install that exact version and keep it in
