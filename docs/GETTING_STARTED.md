...
This source targets `4.0.14`; verify the published version in the npm registry.
...
After the npm registry lists `4.0.14`, install that exact version and keep it in
your lockfile while validating the native build:

```sh
pnpm add unified-ble-manager@4.0.14
```
