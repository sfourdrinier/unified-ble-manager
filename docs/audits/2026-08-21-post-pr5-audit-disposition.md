...
| Local package gate | `pnpm test:package`: 140 suites / 1,310 tests; `pnpm test:plugin`: 36 tests; docs/API, native protocol, artifact, smell, lint/typecheck, and diff checks included | Green locally |
