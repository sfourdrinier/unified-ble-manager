...
tip `4ec3298df86a77dc38f222c2cbd7cd71c08963f2`; subsequent commits in this
...
| Review/release | PR #41 is open; first Copilot/Codex findings and current Codex threads are dispositioned through `4ec3298`; F-32 is now fixed with 52 focused CoreBluetooth lifecycle tests, while hosted rerun, external review, merge, and RC3 remain pending | Blocking; RC2 remains immutable |
