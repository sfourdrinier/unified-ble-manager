...
| F-003, F-004, F-005, F-006, F-007, F-019                                                  | Confirmed / closure | PR6B — host parity, examples, protocol and restoration truth                                                               |
...
| F-016                                                                                     | Confirmed / defer   | PR6C provider discovery-kind descriptors; acceptance test per provider                                                     |
...
| D-002, D-003, D-004, D-005, D-006, D-007, D-008, D-009, D-010, D-011, D-012, D-014 | Confirmed / closure                  | PR6D — current application-first docs and examples                                                                                                      |
...
2. **PR6B — host truth:** implement or remove Expo runtime construction, migrate Node and Electron renderer façades, remove all `@ts-nocheck` from TypeScript under both `example/` and `example-expo/`, align protocol v2 axes, and make restoration identity host-authoritative.
