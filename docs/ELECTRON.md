...
**RC3 candidate under preparation:** `4.0.0-rc.3`. The tag-driven release will publish Node-API v8 prebuilds covering macOS and Windows `arm64`/`x64` for both Node and modern Electron.
