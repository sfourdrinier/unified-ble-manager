...
**Current prerelease:** `4.0.0-rc.5` is published from exact `main` and is immutable. The release ships Node-API v8 prebuilds covering macOS and Windows `arm64`/`x64` for both Node and modern Electron.
