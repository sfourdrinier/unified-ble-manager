...
This guide targets `5.0.0-rc.8`. Web Bluetooth support still depends on the browser, operating system, adapter, and peripheral. UBM reports those runtime boundaries; it does not fabricate a fallback backend.
...
```sh
pnpm add unified-ble-manager@5.0.0-rc.8
```
