...
The current candidate is `5.0.0-rc.9`; rc.8 is immutable published history.
...
- npm `next` resolves to `5.0.0-rc.9`, while `latest` remains on the 4.0 stable
...
- a clean consumer, in a directory outside this repository, can install
  `unified-ble-manager@5.0.0-rc.9` explicitly and import the documented host
