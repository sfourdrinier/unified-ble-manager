...
function legPack() {
  ...
  if (!tarball.endsWith('unified-ble-manager-5.0.0-rc.4.tgz')) {
    fail(`packed ${tarballName}, not the 5.0.0-rc.4 candidate`)
  }
...
function legIdentity(installed, addon) {
  ...
  if (manifest.version !== '5.0.0-rc.4') fail(`installed version ${manifest.version} is not the candidate`)
  ...
  if (seal.package.version !== '5.0.0-rc.4') fail('seal package version is not the candidate')
