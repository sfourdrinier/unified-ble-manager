...
`unified-ble-manager` (the published, immutable `4.0.0-rc.5` prerelease; stable `4.0.0` follows the post-PR12 release gate), configure native permissions and lifecycle
