...
export const VALID_FIXTURES: readonly ValidFixture[] = [
  ...
  { name: 'stream-limits-notification', kind: 'stream-limits', value: { itemCapacity: 64, byteCapacity: 1048576, reservedControlCapacity: 1 } },
  { name: 'stream-limits-min', kind: 'stream-limits', value: { itemCapacity: 1, byteCapacity: 2, reservedControlCapacity: 1 } },
  ...
  { name: 'capability-supported', kind: 'capability', value: { id: 'central.scan', state: 'supported' } },
  ...
  { name: 'peripheral-service', kind: 'peripheral-service', value: { uuid: '180D', primary: true } },
